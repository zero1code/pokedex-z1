...
sealed class PokemonDetailsEvent {
    ...
    data class AddFavorite(val userId: String, val pokemon: Pokemon) : PokemonDetailsEvent()
    data class RemoveFavorite(val userId: String, val pokemon: Pokemon) : PokemonDetailsEvent()
}