package com.z1.pokedex.feature.favorites.domain.repository.mapper

import com.z1.pokedex.core.database.mapper.BaseEntityMapper
...
fun List<PokemonFavoriteEntity>?.asModel(): List<Pokemon> =
    PokemonFavoriteEntityMapper.asModel(this.orEmpty())
